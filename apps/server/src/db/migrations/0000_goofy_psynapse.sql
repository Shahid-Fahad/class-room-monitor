...
CREATE TYPE "public"."role_name" AS ENUM('Super Admin', 'Chairman', 'Admin', 'CR', 'Teacher', 'Student');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "class_delivery_status" (
	"id" varchar(26) PRIMARY KEY NOT NULL,
	"scheduled_class_id" varchar,
	"rescheduled_class_id" varchar,
...
CREATE TABLE "rescheduled_class" (
	"id" varchar(26) PRIMARY KEY NOT NULL,
	"original_class_id" varchar NOT NULL,
...
ALTER TABLE "class_delivery_status" ADD CONSTRAINT "class_delivery_status_scheduled_class_id_scheduled_class_id_fk" FOREIGN KEY ("scheduled_class_id") REFERENCES "public"."scheduled_class"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "class_delivery_status" ADD CONSTRAINT "class_delivery_status_rescheduled_class_id_rescheduled_class_id_fk" FOREIGN KEY ("rescheduled_class_id") REFERENCES "public"."rescheduled_class"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "class_delivery_status" ADD CONSTRAINT "class_delivery_status_marked_by_id_user_id_fk" FOREIGN KEY ("marked_by_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "rescheduled_class" ADD CONSTRAINT "rescheduled_class_original_class_id_scheduled_class_id_fk" FOREIGN KEY ("original_class_id") REFERENCES "public"."scheduled_class"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "rescheduled_class" ADD CONSTRAINT "rescheduled_class_room_id_room_id_fk" FOREIGN KEY ("room_id") REFERENCES "public"."room"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
